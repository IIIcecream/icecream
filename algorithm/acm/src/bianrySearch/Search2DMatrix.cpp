#include "binarySearch\Search2DMatrix.h"
#include <iostream>
using namespace std;

bool Search2DMatrix::solve()
{
    try
    {
...
// ËÑË÷¶þÎ¬¾ØÕó LeetCode T74
bool Search2DMatrix::searchMatrix(int** matrix, int matrixRowSize, int matrixColSize, int target)
{
...
bool Search2DMatrix::binarySearch(int **arr, int nLow, int nHigh, int nTarget, int nCol)
{
